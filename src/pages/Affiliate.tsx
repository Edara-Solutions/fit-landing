    ...
    <div className="flex flex-col">
      ...
      <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden bg-black">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10 w-full text-center flex flex-col items-center">
          <span className="text-primary font-black tracking-widest uppercase mb-6 block text-sm">Fox Elite Network</span>
          <motion.h1 
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10">
          <div className="max-w-2xl">
            ...
            <p className="text-lg text-zinc-400 mb-12">
              We don't accept everyone. We are looking for athletes, trainers, and influencers who live the FOX ethos. If you are built to perform and ready to dominate your space, submit your application.
            </p>
