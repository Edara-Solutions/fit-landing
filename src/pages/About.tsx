        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-zinc-400 mb-6 leading-relaxed">
              FOX Supplements was forged in the fires of competitive necessity. We saw a market saturated with under-dosed, proprietary blends hiding behind flashy marketing. The mission was brutally simple: engineer the highest-grade, scientifically validated sports nutrition on the planet.
            </p>
